...
<div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
  ...
  <center><img src="https://i0.wp.com/digitalumuganda.com/wp-content/uploads/2019/09/LOGO-DIGITAL-UMUGANDA.png?w=2597&ssl=1" width="100px" height="100px"></img></center>
    <h1 className="font-bold text-center text-2xl mb-5">Digital Umuganda </h1>  
        ...
        <div className="grid grid-cols-2 gap-1">
          <div className="text-center sm:text-left whitespace-nowrap">
            <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-200 focus:outline-none focus:bg-gray-300 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                ...
                <span className="inline-block ml-1">Visit Digitalumuganda.com</span>
            </button>
          </div>
        </div>
      </div>
